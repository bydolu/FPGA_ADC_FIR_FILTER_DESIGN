...
set_property -dict {PACKAGE_PIN A13 IOSTANDARD LVCMOS33} [get_ports {ADC[0]}]
#set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33     } [get_ports { ADC[0] }]; #IO_L9N_T1_DQS_AD3N_15 Sch=xa_n[1]
set_property -dict {PACKAGE_PIN A14 IOSTANDARD LVCMOS33} [get_ports {ADC[1]}]
#set_property -dict { PACKAGE_PIN A13   IOSTANDARD LVCMOS33     } [get_ports { ADC[1] }]; #IO_L9P_T1_DQS_AD3P_15 Sch=xa_p[1]
#set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33     } [get_ports {        }]; #IO_L8N_T1_AD10N_15 Sch=xa_n[2]
#set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33     } [get_ports {        }]; #IO_L8P_T1_AD10P_15 Sch=xa_p[2]
