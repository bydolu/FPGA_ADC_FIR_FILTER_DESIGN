...
HD_PWD='C:/Users/bd/Desktop/Proje_dosyalari/Proje_dosyalari/project_14/project_14.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FLOW_METER_SYSTEM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FLOW_METER_SYSTEM.tcl -notrace
